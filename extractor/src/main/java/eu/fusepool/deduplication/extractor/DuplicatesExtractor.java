...
public class DuplicatesExtractor extends RdfGeneratingExtractor {
	...
	private static final Logger log = LoggerFactory.getLogger(DuplicatesExtractor.class);
